...
public class Zadatak_3_Count_Words {

	public static void main(String[] args) {
		/*
		 * *12.19 (Count words) Write a program that counts the number of words
		 * in President Abraham Lincoln’s Gettysburg address from
		 * http://cs.armstrong.edu/liang/data/ Lincoln.txt.
		 */

		System.out
				.println("Connecting to http://cs.armstrong.edu/liang/data/Lincoln.txt");
		URL url = null;
		try {
