...
public class Zadatak_2_Add_Package_Statament {

	public static void main(String[] args) {
		/*
		 * **12.18 (Add package statement) Suppose you have Java source files
		 * under the directories chapter1, chapter2, . . . , chapter34. Write a
		 * program to insert the statement package chapteri; as the first line
		 * for each Java source file under the directory chapteri. Suppose
		 * chapter1, chapter2, . . . , chapter34 are under the root directory
		...
		if (packageDirs.isEmpty()) {
			System.out.print("No package directories found in "
					+ mainDir.getName());
			System.exit(2);
		}
