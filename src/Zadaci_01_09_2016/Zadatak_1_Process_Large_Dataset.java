...
public class Zadatak_1_Process_Large_Dataset {

	public static void main(String[] args) throws MalformedURLException, IOException {
		/*
		 * *12.25 (Process large dataset) A university posts its employees’
		 * salaries at http:// cs.armstrong.edu/liang/data/Salary.txt. Each line
		 * in the file consists of a faculty member’s first name, last name,
		 * rank, and salary (see Programming Exercise 12.24). Write a program to
		 * display the total salary for assistant professors, associate
		 * professors, full professors, and all faculty, respectively, and
