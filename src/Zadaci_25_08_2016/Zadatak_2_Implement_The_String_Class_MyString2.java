...
public class Zadatak_2_Implement_The_String_Class_MyString2 {
	...
	public static void main(String[] args) {
		...
		MyString2 s = new MyString2("SamIr KaHvedzic");
		System.out.println();
		System.out.println("Poredjenje (Samir): " + s.compare("Samir"));
